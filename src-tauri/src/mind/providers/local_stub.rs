//! `LocalStubProvider` — deterministic stub for Phase 0a.
//!
...
#[async_trait]
impl InferenceProvider for LocalStubProvider {
    async fn generate(
        &self,
...
mod tests {
    ...
    fn capabilities_advertise_local_stub() {
        let cap = LocalStubProvider::new().capabilities();
