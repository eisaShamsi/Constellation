...
|---|---|---|---|---|
| PJ-038 | Sight v3 build (MIG-019 next-up — density + time + search + universe-health) | **In-Progress** (1 of 3 MIGs done; MIG-018 closed 2026-05-07) | P1 | Multi-MIG |
...
**End of v1.7.** Thirty-two jobs across nine sections (unchanged count — no new PJs allocated). MIG-018 closed Done (PJ-038 phase 1 of 3). MIG-019 next-up: density + time + search + universe-health card.
