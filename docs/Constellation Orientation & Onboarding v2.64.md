...
## 8. Migrations (active state, 2026-06-09 — v2.61 refresh: MIG-036→072 folded in)
...
| **CCS — Constellation Circulatory System** (the circulatory register for the Connection question; peer of CNS; the pulse of the link graph) | [`docs/Constellation-Circulatory-System-Concept-Paper-v1.1.md`](docs/Constellation-Circulatory-System-Concept-Paper-v1.1.md) (RATIFIED; `/migration` pending) |
