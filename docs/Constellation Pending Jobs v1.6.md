...
**End of v1.6.** Thirty-two jobs across nine sections (unchanged count from v1.4/v1.5 — no new PJs allocated). PJ-037 retired Rejected; PJ-038 Concept Paper ratified at v1.1 and ready for MIG-018. The Sight v3 trajectory in §8 is now ratified design + ready to begin.
