...
|---|---|---|---|---|
| PJ-005 | MIG-007: Links Settings tab | **Open** (top of queue after PJ-006 closed in v1.3) | P1 | Single MIG |
...
| PJ-006 | Living Link Architecture P2–P5 (all phases verified shipped & user-validated) | 2026-05-06 (closed in v1.3 cross-check; shipped earlier in CE Phase §90-§142 commit range) | (multi-commit; orientation §4.4 line 1167+ for canonical state) |
