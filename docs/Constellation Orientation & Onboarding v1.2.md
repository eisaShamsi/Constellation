...
- **Badge letters W and M** — defined in [`ConstellationMap.svelte:80-84`](src/lib/components/ConstellationMap.svelte:80) with colors but no documentation. To be clarified by project owner.
...
*End of v1.2. Maintained per Standing Order #6.*
