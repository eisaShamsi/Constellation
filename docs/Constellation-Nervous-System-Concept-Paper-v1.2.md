# Constellation Nervous System (CNS / الجهاز العصبي للمعرفة) — Concept Paper v1.2

**Status: RATIFIED by Eisa, 2026-06-11.** Supersedes v1.1 (same day; preserved on disk per the
new-file-per-revision rule). **v1.2 carries exactly one amendment — Eisa's own Arabic title:
"الجهاز العصبي للمعرفة"** (the Nervous System of Knowledge), replacing the recommended
الجهاز العصبي للكوكبة in ruling Q7 (Eisa, at Plan approval: *"Approved. But, I will use 'الجهاز العصبي
للمعرفة' as the Arabic equivalent to 'CNS'"*). v1.1 locked: the **identity** (§1–§2: CNS is the original
April-2026 instrument, kept), the **keep decision** (§2.1), the **four registers + Hubs** (§5), the
**CCS boundary + vocabulary ruling** (§6), and the **seven rulings** (§13, all as recommended — Eisa:
*"I accept your logic. Proceed!"*). The MIG-075 Plan executes this paper.
...
| **Q7** | ✅ The native title ships ×15 — Arabic **الجهاز العصبي للمعرفة** (*Eisa's own term, amended at Plan approval 2026-06-11, replacing the recommended للكوكبة*); the other 13 follow the same semantic — *the Nervous System of Knowledge* — in their native forms (en keeps the brand form "Constellation Nervous System (CNS)" per the 2026-05-14 ruling) |
...
*End of v1.2 (RATIFIED; the Q7 Arabic-title amendment). New file per revision; v1.0/v1.1 preserved. The founding mission is
