...
**Version 2.13 | 2026-09-13 — PJ-454 CLOSED: all 43 stamped molds repaired (4 موسوعة عيسى on 09-11, 39 Eisa Universe on 09-13), Boss-passed on every stage and disk-confirmed; the deliberate-failure rehearsal DONE (the halt fired on a screen for the first time). Before the click, a measurement found the door would have listed Eisa Universe's molds TWICE (74 rows for 39 files) because the scan walked nested libraries again — fixed the Reproduce-First way, panel-ruled, inspected twice (one regression of the fix caught and closed); the banner's dismiss flag now resets on universe switch. Filed PJ-464…PJ-473; PJ-461 widened to 75 sites / 21 files. NEXT: PJ-461 (its own build and sitting), then PJ-466 (halt-screen wording) before PJ-456's wave.**
