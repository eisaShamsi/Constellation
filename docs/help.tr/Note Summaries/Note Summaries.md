...
Varsayılan olarak özetler **tembelce ve nazikçe** dolar: kartlar görünüme kaydıkça, arama sonuçları belirdikçe, bir notu açtıkça ya da bir terimi genişlettikçe / bir baloncuğun üzerine geldikçe, Constellation eksik özetleri birkaçı bir arada hesaplar, bir Kütüphane sınıflandırma taraması çalışırken duraklayarak ikisinin kaynaklar için asla yarışmamasını sağlar. Bu, uygulamayı duyarlı tutar — bir kartı / sonucu / açılmış bir notu / satırı / ipucunu özetinden önce kısaca görebilirsiniz, sonra özet bir an sonra belirir.
