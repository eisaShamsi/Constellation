...
**Version 2.33 | 2026-05-25**

> **What changed in v2.33** (**MIG-048 Phase 1 — SHIPPED end-to-end**; Constellation Mind has a working chat surface in the left dock, a 6-tool dispatcher with GBNF-constrained tool calls, a canonical Arabic-first system prompt with citation discipline + MA-5 data-vs-instructions guard, post-stream citation validation with a 1-retry budget, app-start pre-warm (~10× first-turn latency win), sliding-window history trim, and a 15-locale i18n fill. This is the **first conversational moment** in Constellation's history — you can ask your Universe a question and get an answer with clickable citations back to the source notes):
>
