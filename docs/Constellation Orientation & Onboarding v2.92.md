...
> **What changed in v2.92** (**MIG-082 OPENED — the clickable Calendar; §A COMPLETE (§A.1–§A.4) SHIPPED + Boss-validated + pushed: cells are interactive (dots open items, empty space → daily note), task dots open the note AT the task's line, tasks toggle complete from the calendar with a single-ownership reconcile, + Indian/Buddhist calendars and month numbers**):
>
...
> - **REMAINING:** §B (Chinese + Korean lunisolar, Intl-only branch — the polyfill throws on their leap months), §C (close-out: cultural-date frontmatter + ×15 i18n for the new calendar/system strings + audit + the deferred inspector360 bug). Per-feature behaviour in the body §4.x; the Plan drives the steps.
>
> ---
>
