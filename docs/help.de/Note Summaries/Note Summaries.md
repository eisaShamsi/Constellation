...
Standardmäßig füllen sich Zusammenfassungen **träge und behutsam**: Während Karten ins Sichtfeld scrollen, während Suchergebnisse erscheinen, während Sie eine Notiz öffnen oder während Sie einen Begriff aufklappen / eine Blase überfahren, berechnet Constellation die fehlenden Zusammenfassungen in kleinen Mengen und pausiert immer dann, wenn ein Library-Klassifizierungsscan läuft, sodass die beiden niemals um Ressourcen konkurrieren. Das hält die App reaktionsfähig — Sie sehen eine Karte / ein Ergebnis / eine geöffnete Notiz / eine Zeile / einen Tooltip möglicherweise kurz, bevor ihre Zusammenfassung erscheint, dann taucht die Zusammenfassung einen Moment später auf.
