...
|---|---|---|---|---|
| PJ-038 | Sight v3 build with own dedicated Concept Paper | **Confirmed · next-up** | P1 | Multi-MIG |
...
| PJ-009 | Backlinks panel typed-link duplication | Open | P2 (pair w/ PJ-008) | Single-file fix |
...
| PJ-039 | MIG-017: Disable v2 Sight (precondition for v3) | Done | 2026-05-07 (single mini-MIG) | (this v1.5 commit) |
...
**End of v1.5.** Thirty-two jobs across nine sections (unchanged count from v1.4 — no new PJs allocated). PJ-039 closes Done. Top of queue rotates to **PJ-038 (Sight v3 build with own Concept Paper)** — the trajectory laid out in §8 is now ready to begin.
