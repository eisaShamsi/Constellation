				...
				<div class="calendar-page">
					...
					<div class="calendar-page-body">
						<CalendarPanel
							...
							chineseYearStyle={$appSettings.calendarChineseYearStyle ?? 'sexagenary-gregorian'}
							koreanYearStyle={$appSettings.calendarKoreanYearStyle ?? 'dangi'}
							monthNameStyle={$appSettings.calendarMonthNameStyle ?? 'native'}
						...
						{#if $appSettings.showDashboard}
							<div class="home-dashboard">
								...
								<DashboardView
									...
									onNoteToScreen={(note) => {
										// SS-Cockpit §2 — the SS dashboard-note RO copy is cut: a home-dashboard
										// note click always opens in MAIN (the single-owner path).
