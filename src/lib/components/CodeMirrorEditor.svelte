<script lang="ts">
	...
	const obsidianTheme = EditorView.theme({
		...
		'.cm-content': {
			fontFamily: 'var(--vault-mono-font, "Cascadia Code", "Fira Code", "JetBrains Mono", "Consolas", monospace)',
			lineHeight: '1.7',
			padding: '0',
			caretColor: 'var(--vault-accent, #7c3aed)',
		},
		'.cm-cursor': {
			borderLeftColor: 'var(--vault-accent, #7c3aed)',
		},
		'.cm-gutters': {
