<script lang="ts">
	...
	function sectionIcon(icon: string): string {
		const icons: Record<string, string> = {
			...
			brain: 'M12 2C8.5 2 6 4.5 6 7c0 1.5.7 2.8 1.7 3.7C6.1 11.5 5 13.1 5 15c0 2.8 2.2 5 5 5h4c2.8 0 5-2.2 5-5 0-1.9-1.1-3.5-2.7-4.3C17.3 9.8 18 8.5 18 7c0-2.5-2.5-5-6-5zm0 2c2 0 4 1.5 4 3s-1.3 2.5-2.5 3c-.3.1-.5.4-.5.7v.3h-2v-.3c0-.3-.2-.6-.5-.7C9.3 9.5 8 8.5 8 7s2-3 4-3z',
