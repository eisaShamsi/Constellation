...
<style>
	...
	.pe-title { font-size: 0.78rem; font-weight: 600; color: #5c5c66; }
	.pe-saving { font-size: 0.7rem; color: #7c3aed; }

	.pe-row {
		display: flex; align-items: center; gap: 6px;
		padding: 4px 0; border-bottom: 1px solid #f0f0f4;
	}
	...
	.pe-type-btn {
		...
		color: #8b8b96; cursor: pointer; font-size: 0.85rem;
		padding: 0;
	}
	.pe-type-btn:hover { background: #e0e0e4; color: #5c5c66; }

	.pe-key {
		width: 90px; min-width: 60px; flex-shrink: 0;
		border: none; background: none; padding: 3px 4px;
		font-size: 0.82rem; font-weight: 500; color: #5c5c66;
		font-family: inherit; outline: none;
		border-radius: 3px; text-align: end;
	}
	.pe-key:focus { background: #fff; box-shadow: 0 0 0 1px #7c3aed44; }

	.pe-val {
		flex: 1; min-width: 0;
		border: none; background: none; padding: 3px 6px;
		font-size: 0.82rem; color: #1f2328;
		font-family: inherit; outline: none;
		border-radius: 3px;
	}
	.pe-val:focus { background: #fff; box-shadow: 0 0 0 1px #7c3aed44; }
	...
	.pe-tag {
		...
		background: #e8e8ec; color: #5c5c66;
		padding: 1px 6px; border-radius: 10px;
		font-size: 0.75rem; white-space: nowrap;
	}
	.pe-tag-x {
		border: none; background: none; color: #8b8b96;
		cursor: pointer; font-size: 0.75rem; padding: 0 1px;
		line-height: 1;
	}
	.pe-tag-x:hover { color: #cf222e; }
	.pe-tag-input {
		flex: 1; min-width: 50px; border: none; background: none;
		padding: 2px 4px; font-size: 0.78rem; color: #1f2328;
		font-family: inherit; outline: none;
	}
	...
	.pe-link-bracket { color: #7c3aed; font-size: 0.82rem; font-weight: 600; flex-shrink: 0; }
	.pe-link-input { flex: 1; color: #7c3aed; }

	.pe-del {
		width: 20px; height: 20px; flex-shrink: 0;
		display: flex; align-items: center; justify-content: center;
		border: none; background: none; border-radius: 3px;
		color: #b0b0b8; cursor: pointer; padding: 0;
		opacity: 0; transition: opacity 0.15s;
	}
	.pe-row:hover .pe-del { opacity: 1; }
	.pe-del:hover { background: #fde8e8; color: #cf222e; }

	.pe-add {
		display: block; width: 100%; margin-top: 6px;
		border: 1px dashed #d0d0d6; border-radius: 4px;
		background: none; padding: 4px 8px;
		color: #8b8b96; font-size: 0.78rem; font-family: inherit;
		cursor: pointer; text-align: start;
	}
	.pe-add:hover { border-color: #7c3aed; color: #7c3aed; }
</style>
