...
export const CONSTELLATION_CORE_BLOCKS: StyleSettingsBlock[] = [
	...
	},
	{
		...
		settings: [
			...
			{ id: 'ss-comp-ft', type: 'heading', title: 'File explorer (left sidebar)', description: 'One master setting per property — applies uniformly to every row in the file explorer (Universe notes, child universes, libraries, folders, and notes).', level: 2 },
			{ id: 'ft-master-font-size', type: 'variable-number-slider', title: 'Font size', min: 10, max: 22, step: 1, default: '', format: 'px' },
			{ id: 'ft-master-weight', type: 'variable-number-slider', title: 'Weight', min: 300, max: 900, step: 100, default: '' },
			{ id: 'ft-master-color', type: 'variable-color', title: 'Text color', format: 'hex', default: '' },
			{ id: 'ft-master-row-padding-y', type: 'variable-number-slider', title: 'Row spacing', description: 'Vertical padding above and below every row', min: 0, max: 10, step: 1, default: '', format: 'px' },
