...
export const CONSTELLATION_CORE_BLOCKS: StyleSettingsBlock[] = [
	...
	},
	{
		...
		settings: [
			...
			{ id: 'ss-comp-ft-master', type: 'heading', title: 'All tiers at once (master)', description: 'Apply one setting across Universe, cUniverse, Library, Folder, and Note rows. Each tier-specific control below overrides the master for that tier only.', level: 3 },
			{ id: 'ft-master-font-size', type: 'variable-number-slider', title: 'Font size (all tiers)', min: 10, max: 22, step: 1, default: '', format: 'px' },
			{ id: 'ft-master-weight', type: 'variable-number-slider', title: 'Weight (all tiers)', min: 300, max: 900, step: 100, default: '' },
			{ id: 'ft-master-color', type: 'variable-color', title: 'Text color (all tiers)', format: 'hex', default: '' },
			{ id: 'ft-master-row-padding-y', type: 'variable-number-slider', title: 'Row spacing (all tiers)', description: 'Vertical padding above and below every row', min: 0, max: 10, step: 1, default: '', format: 'px' },

			{ id: 'ss-comp-ft-tiers', type: 'heading', title: 'Per-tier overrides', description: 'Fine-tune an individual tier. A tier value overrides the master above.', level: 3 },
			{ id: 'ft-universe-font-size', type: 'variable-number-slider', title: 'Universe notes size', description: 'Root Universe notes entry at the top of the sidebar', min: 10, max: 22, step: 1, default: '', format: 'px' },
			{ id: 'ft-universe-weight', type: 'variable-number-slider', title: 'Universe notes weight', min: 300, max: 900, step: 100, default: '' },
			{ id: 'ft-universe-color', type: 'variable-color', title: 'Universe notes color', format: 'hex', default: '' },
			{ id: 'ft-cuniverse-font-size', type: 'variable-number-slider', title: 'Child universe size', description: 'Linked child universes shown in the sidebar', min: 10, max: 22, step: 1, default: '', format: 'px' },
			{ id: 'ft-cuniverse-weight', type: 'variable-number-slider', title: 'Child universe weight', min: 300, max: 900, step: 100, default: '' },
			{ id: 'ft-cuniverse-color', type: 'variable-color', title: 'Child universe color', format: 'hex', default: '' },
			{ id: 'ft-library-font-size', type: 'variable-number-slider', title: 'Library name size', min: 10, max: 22, step: 1, default: '', format: 'px' },
			{ id: 'ft-library-weight', type: 'variable-number-slider', title: 'Library name weight', min: 300, max: 900, step: 100, default: '' },
			{ id: 'ft-library-color', type: 'variable-color', title: 'Library name color', format: 'hex', default: '' },
			{ id: 'ft-font-size', type: 'variable-number-slider', title: 'Folder & note size', min: 10, max: 20, step: 1, default: '', format: 'px' },
			{ id: 'ft-folder-weight', type: 'variable-number-slider', title: 'Folder weight', min: 300, max: 900, step: 100, default: '' },
			{ id: 'ft-folder-color', type: 'variable-color', title: 'Folder color', format: 'hex', default: '' },
			{ id: 'ft-file-weight', type: 'variable-number-slider', title: 'Note weight', min: 300, max: 900, step: 100, default: '' },
			{ id: 'ft-file-color', type: 'variable-color', title: 'Note color', format: 'hex', default: '' },
			{ id: 'ft-row-padding-y', type: 'variable-number-slider', title: 'Row spacing (vertical)', min: 0, max: 10, step: 1, default: '', format: 'px' },
